...
public class UnitsTest {
    ...
    public void UnitShouldCompareBetweenTwoUnits_01(){
        Units u1 = Units.create(Units.ListOfUnits.feet,1);
        Units u2 = Units.create(Units.ListOfUnits.inch,12);
    ...
    public void UnitShouldCompareBetweenFeetToCm_01(){
        Units u1 = Units.create(Units.ListOfUnits.feet,1);
        Units u2 = Units.create(Units.ListOfUnits.cm,12);
    ...
    public void UnitShouldCompareBetweenInchToCm_01(){
        Units u1 = Units.create(Units.ListOfUnits.inch,2);
        int expected = -(int) (2 - (0.8*0.4));
        Units u2 = Units.create(Units.ListOfUnits.cm,0.8);
    ...
    public void UnitShouldCompareBetweenInchToM_01(){
        Units u1 = Units.create(Units.ListOfUnits.inch,1);
        Units u2 = Units.create(Units.ListOfUnits.cm,0.4);
    ...
    public void UnitShouldCompareBetweenFeetToM_01(){
        Units u1 = Units.create(Units.ListOfUnits.feet,1);
        Units u2 = Units.create(Units.ListOfUnits.m,0.3);
        assertEquals(0,u1.compare(u2));
    }
    @Test
